...
namespace MovieTrackerBundle\Form\Extension\Type;
...
class DeleteType extends AbstractType implements SubmitButtonTypeInterface
{
    public function buildView(FormView $view, FormInterface $form, array $options)
    {
        ...
        $view->vars['confirmation_message'] = !empty($options['confirmation_message']) ? $options['confirmation_message'] : 'Are you sure you would like to delete this?';
    }
